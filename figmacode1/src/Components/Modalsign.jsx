  ...
  return (
    ...
    >
      <div className="relative bg-black rounded-xl px-12 py-10 flex flex-col gap-5 items-center mx-72">
        ...
        <h1 className="text-3xl font-extrabold line-height: 1.75rem h-full underline decoration-red-600  text-white">
          Sign In
        </h1>
        ...
        <p className="text-red-800 text-xl underline cursor-pointer">
          Find out more
        </p>
        <form>
          ...
          <div className=" p-4 text-lg">
            ...
            <p className="text-green-400 inline">Create on account</p>
          </div>
        </form>
      </div>
    </div>
