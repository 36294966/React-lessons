...
const notify = () => {
  toast(
    <div className="toast-notification">
      <div
        className="bg-red-600 flex items-center justify-end fixed top-6 right-6
       md:right-2 md:w-[459px] w-screen  h-[74px] rounded-lg shadow-lg"
      >
        <div className="text-white flex items-center">
          <MdOutlineWarningAmber className="mr-16 text-2xl" />
          <p className=" justify-center items-center mr-6 px-4">
            You are not eligible for this round
            <br />
            <p className="underline text-xl  text-white justify-center">
              Check you mint allocation
            </p>
          </p>
          <IoCloseSharp
            className="cursor-pointer text-2xl mr-4 ml-2"
  ...
  return (
    <div className="bg-blue-950 max-w- md:justify-items-center flex items-start pt-12 px-4">
      <div className="bg-blue-950 rounded-lg w-full  max-w-[523px] md:w-auto md:max-w-[523px] ml-8">
        ...
        <div
          className="w-full md:w-[500px] md:flex md:mr-36 md:flex-col max-w-md mx-auto md:absolute md:right-0 md:m-2
         md:top-32 md:flex-end h-[550px] mb-0"
        >
          <img
            src={logo512}
            alt="logo512"
        ...
        <div className="text-white md:flex-grow  mb-6 mt-12">
          <button className="sm:w-[627px] w-full h-[88px]  bg-gradient-to-r from-[#59256D] to-[#716896] rounded-tl-lg opacity-100">
            <span className="text-2xl p-4 flex flex-start font-bold">
              Coming soon
            </span>
          </button>
        </div>
