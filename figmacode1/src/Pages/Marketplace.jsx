  ...
  return (
    <div className="bg-blue-950 min-h-screen flex justify-start items-start pt-12 px-4">
      <div className="bg-blue-950 rounded-lg w-full max-w-[523px] md:w-auto md:max-w-[523px] ml-8">
        ...
        <div className="w-full md:w-[500px] md:flex md:flex-col max-w-md mx-auto md:absolute md:right-0 md:m-8 md:top-32 md:flex-end h-[750px]">
          <img src={logo512} alt="logo512" className="mx-auto md:mx-0" />
          <div className="bg-blue-950 absolute bottom-0 w-full md:w-[430px] h-[52px]">
            <span className="text-white text-xl gap-60 text-bold flex-1 px-12">
              Round1Quota
        ...
        <div className="text-white md:flex md:flex-col md:grid-cols-2 py-10 px-12 mt-2">
          <button className="w-full md:w-[635px] h-[70px] p-4 flex items-center bg-gradient-to-r from-[#59256D] to-[#716896] rounded-tl-lg opacity-100">
        ...
        <div className="text-white px-12 mt-2">
          ...
          <div className="mt-8 flex-1 px-12 w-full hover:bg-sky-700 h-12 rounded-full bg-blue-400">
