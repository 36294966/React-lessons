...
import Modalverifyoptsignup from"../../Components/Modalverifyopt";

function App() {
  const [showModalverifyoptsignup, setShowModalverifyoptsignup] = useState(false);
            ...
            <div class="flex flex-col-reverse lg:flex-col  max-w-full items-center">
              <div className="mt-8 flex-1 px-12 py-4  w-[265px] hover:bg-sky-700 h-[70px] rounded-full bg-blue-400">
                <div className="flex justify-center">
                  <button
                    onClick={() => setShowModalverifyoptsignup(true)}
                    className="mt-2"
                  >
                    <span>Sign in to mint</span>
                  </button>
                  {showModalverifyoptsignup && (
                    <Modalverifyoptsignup onClose={() => setShowModalverifyoptsignup(false)} />
                  )}
                </div>
              </div>
